...
(async () => {
  ...
  vm.runInNewContext(main, {
    require(name) {
      ...
      const knownService = ['./launchers/scanners.cjs', './storage/app-storage.cjs', './storage/document-store.cjs', './storage/storage-scan-service.cjs', './ipc/registry.cjs', './ipc/failure-log.cjs', './diagnostics/diagnostic-recorder.cjs', './system/system-health-service.cjs', './playtime/playtime-history-service.cjs', './images/image-cache-service.cjs', './app/app-os-service.cjs', './app/app-lifecycle-service.cjs', './doctor/launch-doctor-service.cjs', './saves/save-service.cjs', './optimize/junk-service.cjs', './optimize/process-inspection-service.cjs', './game/external-game-watch-service.cjs', './game/game-launch-service.cjs', './emulation/rom-scan-service.cjs', './providers/store-provider-service.cjs', './providers/public-web-provider-service.cjs', './providers/specialist-metadata-provider-service.cjs', './providers/metadata-candidate-service.cjs', './providers/gemini-provider-service.cjs', './providers/news-normalization-service.cjs', './providers/public-news-provider-service.cjs', './providers/weekly-release-provider-service.cjs', './providers/steam-news-provider-service.cjs', './providers/owned-news-provider-service.cjs', './providers/update-history-provider-service.cjs', './providers/deals-provider-service.cjs', './providers/update-scan-coordinator-service.cjs', './providers/update-source-discovery-service.cjs', './providers/installed-version-evidence-service.cjs', './providers/update-page-version-service.cjs', './providers/independent-update-assessment-service.cjs', './widgets/widget-package-service.cjs'].includes(name);
  ...
  assert.equal(Object.keys(nativeHandlers).length, 89, 'all current native IPC endpoints still registered');
  for (const channel of channels) {
