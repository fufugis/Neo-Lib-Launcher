...
(async () => {
  ...
  assert.equal(Object.keys(nativeHandlers).length, 96, 'all current native IPC endpoints still registered');
  for (const channel of channels) {
