...
assert.match(mascotCenter, /data-testid="mascot-center-size"/);
assert.match(mascotCenter, /aria-label="Mascot size"/);
...
assert.match(host, /dragControls=\{contextDragControls\}/);
assert.match(host, /fungistContextPosition/);
