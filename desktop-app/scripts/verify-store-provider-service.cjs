...
(async () => {
  ...
  console.log('PASS: extracted Steam/GOG provider preserves query URLs, result mapping, taxonomy enrichment, HTML cleanup, media limits and empty/offline fallbacks. Injected HTTP only; no network request ran.');
