...
assert.equal(DEFAULT_SETTINGS.navigationLayout, 'top');
assert.equal(hydrateSettings({ navigationLayout: 'sidebar' }).navigationLayout, 'sidebar');
assert.equal(hydrateSettings({ navigationLayout: 'floating' }).navigationLayout, 'top');
assert.equal(hydrateSettings({}).coverWallShape, 'portrait');
assert.equal(hydrateSettings({ coverWallShape: 'square' }).coverWallShape, 'square');
assert.equal(hydrateSettings({ coverWallShape: 'invalid' }).coverWallShape, 'portrait');
