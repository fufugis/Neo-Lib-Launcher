...
export const BUILTIN_HOME_WIDGETS = Object.freeze([
  ...
  firstParty('recent', 'Recently active', 'play', { minCols: 1, minRows: 1, defaultCols: 6, defaultRows: 3 }, { description: 'Your latest game sessions in chronological order.' }),
  firstParty('best-games', 'My Best Games', 'play', { minCols: 1, minRows: 1, defaultCols: 6, defaultRows: 3 }, { description: 'A quick view of the games with your highest personal ratings.' }),
  firstParty('chronicle', 'Gaming Chronicle', 'play', { minCols: 1, minRows: 1, defaultCols: 6, defaultRows: 3 }, { description: 'A local timeline of meaningful library and play events.' }),
  firstParty('updates', 'Game Updates', 'updates', { minCols: 1, minRows: 1, defaultCols: 12, defaultRows: 4 }, { description: 'Verified update signals and safe launcher handoffs for installed games.' }),
  firstParty('released-week', 'Recent Game Releases', 'updates', { minCols: 1, minRows: 1, defaultCols: 12, defaultRows: 4 }, { description: 'A selective feed of notable recent releases across supported sources.' }),
  firstParty('health', 'Library Health', 'system', { minCols: 1, minRows: 1, defaultCols: 6, defaultRows: 3 }, { description: 'Missing metadata, artwork and cleanup opportunities at a glance.' }),
  firstParty('storage', 'Storage Control', 'system', { minCols: 1, minRows: 1, defaultCols: 6, defaultRows: 3 }, { description: 'Read-only install-size scans and storage visibility for local games.' }),
]);
