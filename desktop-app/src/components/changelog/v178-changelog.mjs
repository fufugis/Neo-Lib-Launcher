export const V178_CHANGELOG = {
  version: '1.7.8',
  title: 'Architecture, Reliability & FiFi Hotfix Update',
  major: [
    {
      title: 'v1.7.8 hotfixes since the architecture release',
      body: 'Optimize now uses antivirus-friendly aggregate CPU/RAM sampling and hands per-program detail to Task Manager. Difficult indie metadata can recover from exact public titles and official itch pages. Preview artwork and descriptions are clearer, basic game details lead the story, Recent Game Releases covers every supported launcher with major-title priority, Monochrome joins Bright themes, Library gains icon-only mode, Wall shows personal ratings, and mascot alerts/resizing stay readable.',
    },
    {
    ...
    },
    {
      ...
      body: 'Every build carries an exact source fingerprint. Packaging rejects stale renderer output, inspects installer and portable contents, blocks credential-like material and publishes checksums. Older v1.7.3 installations can detect the clean v1.7.8 update tag.',
    },
  ],
  fixes: [
    ...
    'Generic Blue, Gaming and Modern now use visibly lifted Mid surfaces, panels and borders. They retain their navy, esports and warm-graphite identities, but no longer read like additional Dark themes beside Generic Gray and Home.',
    ...
    'Preview hero banners are clearer and more colorful: NEO-LIB now measures brightness and saturation, recovers genuinely dark or washed-out art, preserves already-vivid images, and replaces the heavy full-banner navy veil with lighter title-focused readability protection.',
