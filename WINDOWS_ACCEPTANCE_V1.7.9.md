...
- [ ] In the rebuilt app, switch through all 16 built-in themes and compare palette, Library sidebar artwork, atmosphere, special control decoration, FX intensity and Rest Mode against the previous build. Confirm Custom theme remains disabled. The new package layout has source checks but no installed-app visual comparison yet.
